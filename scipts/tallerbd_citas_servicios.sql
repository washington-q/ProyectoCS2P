...
CREATE TABLE `citas_servicios` (
  ...
  KEY `citaId` (`citaId`),
  CONSTRAINT `citas_servicios_ibfk_1` FOREIGN KEY (`servicioId`) REFERENCES `servicios` (`id`),
  CONSTRAINT `citas_servicios_ibfk_2` FOREIGN KEY (`citaId`) REFERENCES `citas` (`id`)
...
INSERT INTO `citas_servicios` VALUES (1,1,2),(2,2,2),(3,1,3),(4,2,3);
